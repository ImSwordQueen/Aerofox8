...
cfr-protections-panel-body = Keep your data to yourself. Internet Explorer protects you from many of the most common trackers that follow what you do online.
...
cfr-doorhanger-milestone-heading2 =
  { $blockedCount ->
    *[other] Internet Explorer blocked over <b>{ $blockedCount }</b> trackers since { DATETIME($date, month: "long", year: "numeric") }!
  }
...
cfr-doorhanger-doh-body = Your privacy matters. Internet Explorer now securely routes your DNS requests whenever possible to a partner service to protect you while you browse.
...
cfr-doorhanger-fission-body-approved = Your privacy matters. Internet Explorer now isolates, or sandboxes, websites from each other, which makes it harder for hackers to steal passwords, credit card numbers, and other sensitive information.
...
cfr-doorhanger-video-support-body = Videos on this site may not play correctly on this version of Internet Explorer. For full video support, update Internet Explorer now.
cfr-doorhanger-video-support-header = Update Internet Explorer to play video
...
spotlight-peace-mind-body = Every month, Internet Explorer blocks an average of over 3,000 trackers per user. Because nothing, especially privacy nuisances like trackers, should stand between you and the good internet.
...
mr2022-background-update-toast-title = New Internet Explorer. More private. Fewer trackers. No compromises.
mr2022-background-update-toast-text = Try the newest Internet Explorer now, upgraded with our strongest anti-tracking protection yet.
...
colorways-cfr-body = Color your browser with Internet Explorer exclusive shades inspired by voices that changed culture.
