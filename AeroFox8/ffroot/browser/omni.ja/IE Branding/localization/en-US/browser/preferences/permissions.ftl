...
permissions-exceptions-https-only-window2 =
    ...
    .style = { permissions-window2.style }
permissions-exceptions-https-only-desc = You can turn off HTTPS-Only Mode for specific websites. Internet Explorer won’t attempt to upgrade the connection to secure HTTPS for those sites. Exceptions do not apply to private windows.
