...
policy-AppUpdatePin = Prevent Internet Explorer from being updated beyond the specified version.
...
policy-DisableBuiltinPDFViewer = Disable PDF.js, the built-in PDF viewer in Internet Explorer.
...
policy-DisableFirefoxStudies = Prevent Internet Explorer from running studies.
...
policy-DisableProfileRefresh = Disable the Refresh Internet Explorer button in the about:support page.
...
policy-NoDefaultBookmarks = Disable creation of the default bookmarks bundled with Internet Explorer, and the Smart Bookmarks (Most Visited, Recent Tags). Note: this policy is only effective if used before the first run of the profile.

policy-OfferToSaveLogins = Enforce the setting to allow Internet Explorer to offer to remember saved logins and passwords. Both true and false values are accepted.

policy-OfferToSaveLoginsDefault = Set the default value for allowing Internet Explorer to offer to remember saved logins and passwords. Both true and false values are accepted.
...
policy-PasswordManagerExceptions = Prevent Internet Explorer from saving passwords for specific sites.

policy-PDFjs = Disable or configure PDF.js, the built-in PDF viewer in Internet Explorer.
