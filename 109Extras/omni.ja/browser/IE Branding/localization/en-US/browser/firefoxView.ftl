...
firefoxview-tabpickup-synctabs-description = Allow Internet Explorer to share tabs between devices.
...
firefoxview-tabpickup-fxa-admin-disabled-description = Internet Explorer is not able to sync tabs between devices because your administrator has disabled syncing.

firefoxview-tabpickup-network-offline-header = Check your internet connection
firefoxview-tabpickup-network-offline-description = If you’re using a firewall or proxy, check that Internet Explorer has permission to access the web.
...
firefoxview-tabpickup-generic-sync-error-description = Internet Explorer can’t reach the syncing service right now. Try again in a few moments.
...
firefoxview-tabpickup-sync-disconnected-description = To grab your tabs, you’ll need to allow syncing in Internet Explorer.
...
firefoxview-tabpickup-password-locked-description = To grab your tabs, you’ll need to enter the Primary Password for Internet Explorer.
