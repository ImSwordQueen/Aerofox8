...
safeb-blocked-phishing-page-short-desc = Internet Explorer blocked this page because it may trick you into doing something dangerous like installing software or revealing personal information like passwords or credit cards.
safeb-blocked-malware-page-short-desc = Internet Explorer blocked this page because it might attempt to install malicious software that may steal or delete personal information on your computer.
safeb-blocked-unwanted-page-short-desc = Internet Explorer blocked this page because it might try to trick you into installing programs that harm your browsing experience (for example, by changing your homepage or showing extra ads on sites you visit).
safeb-blocked-harmful-page-short-desc = Internet Explorer blocked this page because it might try to install dangerous apps that steal or delete your information (for example, photos, passwords, messages and credit cards).
...
safeb-blocked-phishing-page-learn-more = Learn more about deceptive sites and phishing at <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Learn more about Internet Explorer’s Phishing and Malware Protection at <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more-sumo = Learn more about Internet Explorer’s Phishing and Malware Protection at <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-unwanted-page-learn-more = Learn more about harmful and unwanted software at <a data-l10n-name='learn_more_link'>Unwanted Software Policy</a>. Learn more about Internet Explorer’s Phishing and Malware Protection at <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Learn more about Internet Explorer’s Phishing and Malware Protection at <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
