...
onboarding-welcome-header = Welcome to Internet Explorer
onboarding-start-browsing-button-label = Start Browsing
onboarding-not-now-button-label = Not now


return-to-amo-subtitle = Great, you’ve got Internet Explorer
...
mr1-return-to-amo-subtitle = Say hello to Internet Explorer
mr1-return-to-amo-addon-title = You’ve got a fast, private browser at your fingertips. Now you can add <b>{ $addon-name }</b> and do even more with Internet Explorer.
...
mr1-onboarding-pin-header = { PLATFORM() ->
    [macos] Keep Internet Explorer in your Dock for easy access
   *[other] Pin Internet Explorer to your taskbar for easy access
}
...
mr1-onboarding-welcome-header = Welcome to Internet Explorer
mr1-onboarding-set-default-pin-primary-button-label =
  Make Internet Explorer my primary browser
    .title = Sets Internet Explorer as default browser and pins to taskbar
...
mr1-onboarding-default-header =
    Make Internet Explorer your default
...
mr1-onboarding-theme-subtitle = Personalize Internet Explorer with a theme.
...
mr2-onboarding-thank-you-text = Internet Explorer is an independent browser backed by a non-profit. Together, we’re making the web safer, healthier, and more private.
mr2-onboarding-start-browsing-button-label = Start browsing


onboarding-live-language-header = Choose your language

mr2022-onboarding-live-language-text = Internet Explorer speaks your language

mr2022-language-mismatch-subtitle = Thanks to our community, Internet Explorer is translated in over 90 languages. It looks like your system is using { $systemLanguage }, and Internet Explorer is using { $appLanguage }.
...
fx100-thank-you-pin-primary-button-label = { PLATFORM() ->
    [macos] Keep Internet Explorer in Dock
   *[other] Pin Internet Explorer to taskbar
}

fx100-upgrade-thanks-header = 100 Thank-Yous
fx100-upgrade-thank-you-body = It’s our 100th release of Internet Explorer. Thank <em>you</em> for helping us build a better, healthier internet.
fx100-upgrade-thanks-keep-body = It’s our 100th release! Thanks for being a part of our community. Keep Internet Explorer one click away for the next 100.
...
mr2022-onboarding-welcome-pin-subtitle = Launch Internet Explorer from anywhere with a single click. Every time you do, you’re choosing a more open and independent web.
...
mr2022-onboarding-existing-pin-checkbox-label = Also add Internet Explorer private browsing


mr2022-onboarding-set-default-title = Make Internet Explorer your go-to browser
mr2022-onboarding-set-default-primary-button-label = Set Internet Explorer as default browser
...
mr2022-onboarding-import-subtitle = Set up Internet Explorer how you like it. Add your bookmarks, passwords, and more from your old browser.
...
mr2022-onboarding-colorway-tooltip-default2 =
  .title = Current Internet Explorer colors
mr2022-onboarding-colorway-description-default = <b>Use my current Internet Explorer colors.</b>
...
mr2022-upgrade-onboarding-pin-private-window-primary-button-label = { PLATFORM() ->
    [macos] Keep Internet Explorer private browsing in Dock
   *[other] Pin Internet Explorer private browsing to taskbar
}
...
mr2022-onboarding-gratitude-subtitle = Thank you for using Internet Explorer, backed by the Mozilla Foundation. With your support, we’re working to make the internet more open, accessible, and better for everyone.
...
onboarding-infrequent-import-primary-button = Import to Internet Explorer
