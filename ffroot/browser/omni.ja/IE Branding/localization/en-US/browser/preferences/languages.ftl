...
browser-languages-window2 =
    .title = Internet Explorer Language Settings
    .style = min-width: 40em

browser-languages-description = Internet Explorer will display the first language as your default and will display alternate languages if necessary in the order they appear.
...
browser-languages-error = Internet Explorer can’t update your languages right now. Check that you are connected to the internet or try again.
