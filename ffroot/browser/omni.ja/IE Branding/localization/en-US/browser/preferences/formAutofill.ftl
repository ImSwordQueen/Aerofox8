...
autofill-edit-card-password-prompt = { PLATFORM() ->
    ...
    [windows] Internet Explorer is trying to show credit card information. Confirm access to this Windows account below.
   *[other] Internet Explorer is trying to show credit card information.
}
