...
graph-week-summary =
  { $count ->
     [one] Internet Explorer blocked { $count } tracker over the past week
    *[other] Internet Explorer blocked { $count } trackers over the past week
  }
...
graph-private-window = Internet Explorer continues to  block trackers in Private Windows, but does not keep a record of what was blocked.
graph-week-summary-private-window = Trackers Internet Explorer blocked this week

protection-report-webpage-title = Protections Dashboard
protection-report-page-content-title = Protections Dashboard
protection-report-page-summary = Internet Explorer can protect your privacy behind the scenes while you browse. This is a personalized summary of those protections, including tools to take control of your online security.
protection-report-page-summary-default = Internet Explorer protects your privacy behind the scenes while you browse. This is a personalized summary of those protections, including tools to take control of your online security.
...
etp-card-content-description = Internet Explorer automatically stops companies from secretly following you around the web.
protection-report-etp-card-content-custom-not-blocking = All protections are currently turned off. Choose which trackers to block by managing your Internet Explorer protections settings.
