...
about-logins-os-auth-dialog-caption = Windows Internet Explorer
...
about-logins-confirm-remove-all-dialog-message =
  { $count ->
     [1] This will remove the login you’ve saved to Internet Explorer and any breach alerts that appear here. You won’t be able to undo this action.
    *[other] This will remove the logins you’ve saved to Internet Explorer and any breach alerts that appear here. You won’t be able to undo this action.
  }
...
about-logins-confirm-remove-all-sync-dialog-message=
  { $count ->
     [1] This will remove the login you’ve saved to Internet Explorer on all devices synced to your { -fxaccount-brand-name }. This will also remove breach alerts that appear here. You won’t be able to undo this action.
    *[other] This will remove all logins you’ve saved to Internet Explorer on all devices synced to your { -fxaccount-brand-name }. This will also remove breach alerts that appear here. You won’t be able to undo this action.
  }
...
about-logins-import-dialog-error-file-permission-description = Internet Explorer does not have permission to read the file. Try changing the file permissions.
...
about-logins-import-report-description = Logins and passwords imported to Internet Explorer.
