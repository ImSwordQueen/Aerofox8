...
aboutDialog-title =
    .title = About Windows Internet Explorer
...
update-noUpdatesFound = Internet Explorer is up to date
aboutdialog-update-checking-failed = Failed to check for updates.
update-otherInstanceHandlingUpdates = Internet Explorer is being updated by another instance
...
warningDesc-version = Internet Explorer is experimental and may be unstable.
...
community-2 = Internet Explorer is designed by <label data-l10n-name="community-mozillaLink">{ -vendor-short-name }</label>, a <label data-l10n-name="community-creditsLink">global community</label> working together to keep the Web open, public and accessible to all.
