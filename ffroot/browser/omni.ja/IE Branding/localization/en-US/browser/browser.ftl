...
browser-main-window-window-titles =
  .data-title-default = Windows Internet Explorer
  .data-title-private = Windows Internet Explorer [InPrivate]
  .data-content-title-default = { $content-title } — Windows Internet Explorer
  .data-content-title-private = { $content-title } — Windows Internet Explorer [InPrivate]
browser-main-window-mac-window-titles =
  .data-title-default = Windows Internet Explorer
  .data-title-private = Windows Internet Explorer [InPrivate]
  .data-content-title-default = { $content-title }
  .data-content-title-private = { $content-title } — [InPrivate]

browser-main-window-title = Windows Internet Explorer

private-browsing-shortcut-text-2 = Windows Internet Explorer [InPrivate]
...
quickactions-refresh = Refresh Internet Explorer
quickactions-cmd-refresh = refresh

quickactions-restart = Restart Internet Explorer
...
quickactions-update = Update Internet Explorer
...
identity-connection-internal = This is a secure Internet Explorer page.
...
identity-active-blocked = Internet Explorer has blocked parts of this page that are not secure.
...
identity-https-only-info-turn-on2 = Turn on HTTPS-Only Mode for this site if you want Internet Explorer to upgrade the connection when possible.
...
identity-description-active-blocked = Internet Explorer has blocked parts of this page that are not secure. <label data-l10n-name="link">Learn More</label>
...
identity-description-passive-loaded-mixed = Although Internet Explorer has blocked some content, there is still content on the page that is not secure (such as images). <label data-l10n-name="link">Learn More</label>
...
browser-import-button2 =
    ...
    .tooltiptext = Import bookmarks from another browser to Internet Explorer.
...
sharing-warning-window = You are sharing Internet Explorer. Other people can see when you switch to a new tab.
...
eme-notifications-drm-content-playing = Some audio or video on this site uses DRM software, which may limit what Internet Explorer can let you do with it.
...
navbar-home =
    .label = Home
    .tooltiptext = Internet Explorer Home Page
...
restore-session-startup-suggestion-message = <strong>Open previous tabs?</strong> You can restore your previous session from the Internet Explorer application menu <img data-l10n-name="icon"/>, under History.
restore-session-startup-suggestion-button = Show me how


data-reporting-notification-message = Internet Explorer automatically sends some data to { -vendor-short-name } so that we can improve your experience.
...
refresh-blocked-refresh-label = Internet Explorer prevented this page from automatically reloading.
refresh-blocked-redirect-label = Internet Explorer prevented this page from automatically redirecting to another page.
